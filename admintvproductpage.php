...
if(isset($_POST['submit']) && $_REQUEST['code'] == 'update')
{
  ...
  $sql = "UPDATE tvshow SET title = '$title', year = '$year', season = '$season', genre = '$genre',plot='$plot', imdb='$imdb' WHERE tvshowid = '$tvshowid' ";
...
#cancelbtn{
  ...
  $sql = "SELECT * FROM tvshow WHERE tvshowid='$tvshowid'";
...
<div class="container cont4"><br>
    ...
    <button class="btn btn-primary editbtn" id="editbtn" data-toggle="modal" data-target="#update_modal">Edit</button>
      ...
      <div class="col-md-6" id="movietvproducttitle" >
        ...
        <h4>No of Seasons: <?php echo $row['season']; ?></h4>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <form action="" method="POST" >
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Tv Show Details</h4>
        </div>
        ...
        <label for="season">No of season:</label><br>
    ...
    <?php 
  $tvshowid1 = $_GET['tvshowid'];
  $sql1 = "SELECT * FROM tvshowreview INNER JOIN users ON tvshowreview.username=users.username WHERE tvshowreview.tvshowid='$tvshowid1'";
