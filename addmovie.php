...
if(isset($_POST['submit']))
{
  ...
  $sql = "INSERT INTO movie (title, year, runtime, genre, imdb, plot , img) VALUES ('$title', '$year' ,'$runtime', '$genre', '$imdb', '$plot','$target_file')";
...
<body>
    <center>
    <h1 style="color:white; font-family: 'Roboto', sans-serif;">Add New Movies</h1>
    <button class="btn btn-primary" data-toggle="modal" id="addbtn" data-target="#modalmovie">+</button><br><br><br>

    <div class="modal fade" id="modalmovie" role="dialog">
...
<div class="card col-sm-4" style="width: 25rem; margin-left:10px; margin-right:30px; margin-bottom:60px;">
  ...
  <div class="card-body">
    ...
    <a href="#" id="delbtn" class="btn btn-primary" style="margin-bottom:10px;" data-toggle="modal" data-target="#delete_modal<?php echo $row['movieid']; ?>">Delete</a>
  </div>
</div>

<div id="delete_modal<?php echo $row['movieid']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action="delete-process.php">
        <input type="hidden" name="code" value="removeMovie">
