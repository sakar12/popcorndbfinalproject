...
if(isset($_POST['submit']) && $_REQUEST['code'] == 'updateItem')
{
  ...
  $sql = "UPDATE tvshowreview SET reviewtxt = '$reviewtxt' WHERE id = '$id' ";
...
<body>
<center>
<h1 style="color:white; font-family: 'Roboto', sans-serif;">Tv Show Reviews</h1>
</center>
<br><br>
...
$sql = "SELECT * FROM tvshow INNER JOIN tvshowreview ON tvshow.tvshowid=tvshowreview.tvshowid WHERE username ='$username' ORDER BY createdAt DESC";
...
<table class="table usertable">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="code" value="removeReviewtxtfortv">
...
<div class="modal fade" id="update_modal<?php echo $row['id']; ?>" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <input type="hidden" name="code" value="updateItem">
        ...
        <textarea type="text" id="review" style="height: 60px; width:150px; " name="review" value=""></textarea><br>
        </div>
        <div class="modal-footer">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
