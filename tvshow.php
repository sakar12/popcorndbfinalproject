...
if(!isset($_REQUEST['code']))
{
  ...
  $searchtxt = mysqli_real_escape_string($link, $_POST['searchtxt']);
    $sql = "SELECT * FROM tvshow WHERE LOWER(title) LIKE LOWER('%$searchtxt%')";
...
<body>
<center>
<h1 style="color:white; font-family: 'Roboto', sans-serif;">Tv Shows</h1>
</center>
<br><br>
<form method="post" id="formsearch" class="search-bar" action="tvshow.php">   
    <div class="searchBox"> 
...
<div class="card col-sm-4" style="width: 25rem; margin-left:10px; margin-right:30px; margin-bottom:60px;">
  ...
  <div class="card-body">
    ...
    <a href="tvshowproductpage.php?tvshowid=<?php echo $row['tvshowid'] ?>;" id="morebtn" class="btn btn-primary" style="margin-bottom:10px;">View More</a>
  </div>
</div>
...
<?php 
    ...
    header("location: noresulttvshow.php");
  } //if close
